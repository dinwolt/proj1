                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        setFormData({
                            ...
                            node_X: data.coordinates?.x !== undefined ? String(data.coordinates.x) : "0",
                            node_Y: data.coordinates?.y !== undefined ? String(data.coordinates.y) : "0",
                            node_Z: data.coordinates?.z !== undefined ? String(data.coordinates.z) : "0",
                        })
                    } else {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (nodeId) {
            try {
                ...
                if (name == "" || node_X == "" || node_Y == "" || node_Z == "") alert("Fields cannot be empty")
                else {
